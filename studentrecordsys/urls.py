...
urlpatterns = [
    ...
    path(
        ...
        views.UPDATE_COURSES_DETAILS,
        name="update_courses_details",
    ),
    ...
    path("ViewStudent/<str:id>", views.VIEW_STUDENT, name="view_student"),
    path("UpdateStudent/<str:id>", views.UPDATE_STUDENTS, name="update_student"),
    path(
        "UpdateStudentDetails",
        views.UPDATE_STUDENTS_DETAILS,
        name="update_student_details",
    ),
    path("ViewCourse/<str:id>", views.VIEW_COURSE, name="view_course"),
    path("ViewSubject/<str:id>", views.VIEW_SUBJECT, name="view_subject"),
    path("UpdateSubject/<str:id>", views.UPDATE_SUBJECTS, name="update_subject"),
    path(
        "UpdateSubjectDetails",
        views.UPDATE_SUBJECTS_DETAILS,
        name="update_subject_details",
    ),
